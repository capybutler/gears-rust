...
terms are summed rather than maximised, because retention runs from the end of
the covered period. The sum leaves an entry imported at the far edge of the
window a full replay horizon of deduplication and replay.
