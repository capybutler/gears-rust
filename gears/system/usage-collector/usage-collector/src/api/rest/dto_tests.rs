...
// ---------------------------------------------------------------------------
// TimeRangeDto / AggregationRequest — the aggregate path's
...
fn aggregate_request_parses_the_mandatory_time_range() {
    let req: super::AggregationRequest =
...
fn aggregate_request_without_a_time_range_is_rejected() {
    ...
    let err = serde_json::from_value::<super::AggregationRequest>(
...
fn aggregate_request_rejects_an_unknown_body_field() {
    ...
    let err = serde_json::from_value::<super::AggregationRequest>(json)
...
fn time_range_dto_rejects_an_offsetless_bound() {
    ...
    for bound in ["from", "to"] {
        ...
        assert!(
            serde_json::from_value::<super::AggregationRequest>(json).is_err(),
...
fn time_range_dto_rejects_an_unknown_field_inside_the_range() {
    ...
    serde_json::from_value::<super::AggregationRequest>(json)
